...
<Newsitem title={element.title?element.title:""} description={element.description?element.description.slice(0,119):""} imageURL={element.urlToImage} newsUrl={element.url}></Newsitem>
</div>
      })}
